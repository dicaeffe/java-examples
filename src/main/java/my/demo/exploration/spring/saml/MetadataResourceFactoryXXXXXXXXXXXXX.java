 ...
 */
public class MetadataResourceFactoryXXXXXXXXXXXXX {

  private static final Logger logger = LoggerFactory.getLogger( MetadataResourceFactoryXXXXXXXXXXXXX.class );
  ...
  public MetadataResourceFactoryXXXXXXXXXXXXX( Map<String, String> resourceMap , String classpathResourceFallback ) {
