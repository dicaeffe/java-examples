package my.demo.exploration.libs.spring.service.restful.configuration;
...
public class RESTfulConfApplication {

	public static void main(String[] args) {
		/* Launch an application. */
		SpringApplication.run(RESTfulConfApplication.class, args);
	}
